...
// Class for all the recursion type functions 
template <class T>
class BST {
public:
    BST() {
...
int main()
{
 ...
 // Inserting first four values
 test.insert(67);
 test.insert(190);
 test.insert(3);
 test.insert(23);

 test.recursiveInsert(45);
 test.recursiveInsert(122);
 test.recursiveInsert(196);
 test.recursiveInsert(19);
